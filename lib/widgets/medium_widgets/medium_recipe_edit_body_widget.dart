...
class MediumRecipeEditBodyWidget extends RecipeEditBodyWidget {
  MediumRecipeEditBodyWidget({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    clearWidgets();
    buildIngredientsWidgets(recipeInfo, 175.0);
      ...
      Expanded(
          child: ListView(
              padding: EdgeInsets.only(
                  left: MediaQuery.of(context).size.width / 2 - 350.0,
                  right: MediaQuery.of(context).size.width / 2 - 350.0,
                  top: 50.0),
              children: [
